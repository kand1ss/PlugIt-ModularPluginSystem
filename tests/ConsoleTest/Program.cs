...
class Program
{
    static void Main(string[] args)
    {
        ...
        manager.RegisterAssembly(@"C:\Users\kand1s\Desktop\Plugins\Plugins.dll");
        manager.RegisterAssembly(@"C:\Users\kand1s\Desktop\Plugins\Plugins2.dll");
        ...
        var safety = manager.Security.CheckSafety(@"C:\Users\kand1s\Desktop\Plugins\TestUnsafeAssembly.dll");
        Console.WriteLine(safety);
        manager.RegisterAssembly(@"C:\Users\kand1s\Desktop\Plugins\TestSafeAssembly.dll");
        Console.ReadLine();
        manager.RegisterAssembly(@"C:\Users\kand1s\Desktop\Plugins\TestUnsafeAssembly.dll");
